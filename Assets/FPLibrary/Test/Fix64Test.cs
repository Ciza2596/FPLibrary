...
public class Fix64Test
{
    long[] m_testCases = new[] {
        ...
        public void DoubleToFix64AndBack()
        {
            ...
            {
                AreAreEqualWithinPrecision(value, (double)(Fix64)value);
            }
        }

        static void AreAreEqualWithinPrecision(decimal value1, decimal value2)
        {
            Assert.True(Math.Abs(value2 - value1) < Fix64.Precision);
        }

        static void AreAreEqualWithinPrecision(double value1, double value2)
        {
        ...
        public void DecimalToFix64AndBack()
        {
            ...
            foreach (var value in sources)
            {
                AreAreEqualWithinPrecision(value, (decimal)(Fix64)value);
            }
        }
        ...
        [Test]
        public void AreEqualityAndInAreEqualityOperators()
        {
